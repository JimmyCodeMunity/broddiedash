  ...
  const handleMealUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://server.broddiescollection.com/api/v1/admin/createart",
        formData,
        {
          headers: {
    ...
    <div className="space-y-5">
      <div className="w-full bg-white shadow rounded-xl space-y-4 p-5">
        <div className="w-full flex flex-row items-center justify-between">
          ...
          <Link to="/meals/view" className="text-orange-500">
            View Art
          </Link>
        </div>
        ...
        <div className="w-full">
          ...
          >
            <div className="w-full flex md:flex-row flex-col items-center md:space-x-6 space-y-2">
              <div className="space-y-2 w-full">
                ...
                <input
                  ...
                  type="text"
                  placeholder="edit art name"
                  className="w-full bg-neutral-100 rounded-md p-2"
                />
              </div>
              <div className="space-y-2 w-full">
                <label htmlFor="" className="text-neutral-500">
            ...
            <div className="w-full flex md:flex-row flex-col items-center md:space-x-6 space-y-2">
              <div className="space-y-2 w-full">
                ...
                <textarea
                  id="message"
                  rows="4"
                  class="block p-2.5 w-full text-sm  bg-neutral-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                  value={description}
              ...
              >
                {category ? (
                  <div className="flex items-center space-x-2">
                    <img
                      src={`https://server.broddiescollection.com/${
                        categories.find((cat) => cat.categoryname === category)
                          ?.image
                      }`}
                      alt={category}
              ...
              {isOpen && (
                <div className="absolute w-full bg-white border border-gray-300 rounded-md mt-1 shadow-md z-10">
                  {categories.map((cat) => (
                    ...
                    >
                      <img
                        src={`https://server.broddiescollection.com/${cat.image}`}
              ...
              <div className="space-y-2 w-full">
                ...
                >
                  <div className="w-full border border-neutral-200 min:h-14 py-5 flex flex-col space-y-3 justify-center items-center rounded-xl">
                    ...
                    <p className="text-neutral-500">Art Image</p>
                    {/* Image Preview */}
                    {preview && (
                ...
                <input
                  ...
                  type="file"
                  placeholder="edit"
                  className="w-full hidden bg-neutral-100 rounded-md p-2"
                />
              </div>
            </div>
            <div className="w-full justify-end items-end flex flex-row">
              <button
                type="submit"
                className="p-2 bg-black rounded-md text-white text-md w-40"
              >
                Add Art
              </button>
            </div>
