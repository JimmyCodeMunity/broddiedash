...
export const ApiProvider = ({ children }) => {
  ...
  const getAllCategories = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getcategories"
      );
  ...
  const getAllMeals = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getart"
      );
      const data = response.data;
      setLoading(false);
      setMeals(data);
  ...
  const getAllOrders = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getallorders"
      );
      const data = response.data;
      setLoading(false);
      setAllOrders(data);
      ...
      const totalSales = data.reduce(
        (sum, order) => sum + Number(order.mealid.price),
        0
      );
  ...
  const getStaff = async () => {
    ...
    try {
      const response = await axios.get(
        "http://localhost:5000/api/v1/admin/getstaff"
      );
      const data = response.data;
      setLoading(false);
      setStaff(data);
  ...
  const getUsers = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getcustomers"
      );
      const data = response.data;
      setLoading(false);
      setUsers(data);
  ...
  const getPendingOrders = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getpendingorders"
      );
      const data = response.data;
      setLoading(false);
  ...
  const getCompletedOrders = async () => {
    ...
    try {
      const response = await axios.get(
        "https://server.broddiescollection.com/api/v1/admin/getcompletedorders"
      );
      const data = response.data;
      setLoading(false);
  ...
  const deleteStaff = async (staffid) => {
    ...
    try {
      const response = await axios.delete(
        `https://saccoserver.haramad.co.ke/api/v1/admin/deletestaff/${staffid}`
      );
      const data = response.data;
  ...
  const deleteUser = async (deleteUser) => {
    ...
    try {
      const response = await axios.delete(
        `https://server.broddiescollection.com/api/v1/admin/deleteuser/${deleteUser}`
      );
      const data = response.data;
  ...
  const updateUser = async (userdata) => {
    ...
    try {
      const response = await axios.put(
        `https://saccoserver.haramad.co.ke/api/v1/admin/updateuser/${userdata?.userid}`,
        {
  ...
  const updateOrder = async (orderid, action) => {
    ...
    try {
      const response = await axios.post(
        "https://smokey.haramad.co.ke/api/v1/admin/updateorder",
  ...
  const updateFeatured = async (mealid, action) => {
    ...
    try {
      const response = await axios.post(
        "https://smokey.haramad.co.ke/api/v1/admin/updatefeatured",
        { mealid, featured: action }
      );
      const data = response.data;
  ...
  const updatePopular = async (mealid, action) => {
    ...
    try {
      const response = await axios.post(
        "https://smokey.haramad.co.ke/api/v1/admin/updatepopularity",
        { mealid, popular: action }
      );
      const data = response.data;
