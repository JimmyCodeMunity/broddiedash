...
const BasicPlanCard = () => {
    return (
        <div>
            <div className="">
                <div className="w-full bg-lime-500 rounded-2xl space-y-3 p-5 flex flex-col justify-between">
                    <h1 className="text-xl text-white">Upgrade to Pro</h1>
                    <div>
                        <h1 className="text-2xl font-semibold text-white">Kes.1,400/Month</h1>
                        <h1 className="text-lg text-neutral-500">Kes.13,000 Billed Annually</h1>
                    </div>
                    <div className="w-full">
                        <ul>
                            <li className='flex flex-row items-center'>
                                <Icon.Check className='text-black' />
                                <span className='text-black text-sm'>3 Apartments</span>
                            </li>
                            <li className='flex flex-row items-center'>
                                <Icon.Check className='text-black' />
